...
class GLMAnalyzer:
    ...
    def analyze(self, data: Dict[str, Any], prompt_template: str, max_retries: int = 3) -> str:
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            if "successful" in result.lower():
                ...
                self.logger.warning("GLM API connection test failed - unexpected response")
                return False
